            ...
            <div className='about-outer-container'>
                ...
                <div className="about-container">
                    ...
                    <p className='team-member'>
                        ...
                        On the other side, you can log your daily, monthly or 
                        long term goals. 
                        
                        Our app lets you see who else in your network has similar 
                        dreams/goals and will be able to connect you to be able 
                        to dream up and build awesome things together.
                        </p>
                    <br />
                    <p className="team-member">
                        -
                    ...
                    <p className="team-member">
                        Frontend Lead - 
                            <a 
                                target="_blank" 
                                rel="noreferrer" 
                                href="https://github.com/joshkohane"
                            > 
                                    Josh Kohane
                            </a>
                    </p>
                    <p className="team-member">
                        Backend Lead - 
                            <a 
                                target="_blank" 
                                rel="noreferrer" 
                                href="https://github.com/AlanDai">
                                    Alan Dai
                            </a>
                    </p>
                    <p className="team-member">
                        Frontend/Backend Flex - 
                        <a 
                            target="_blank" 
                            rel="noreferrer" 
                            href="https://github.com/cindy803">Cindy Li
                        </a>
                    </p>
                    <p className="team-member">
                        Team Lead - 
                            <a 
                                target="_blank" 
                                rel="noreferrer" 
                                href="https://github.com/EricaThompson">
                                    Erica Thompson
                            </a>
                    </p>
                </div>
                ...
                <div className="about-container">
                    ...
                    <p className="background-link">
                        <a href='https://www.fiverr.com/doomero' 
                            target="_blank" 
                            rel="noreferrer" 
                            className="background-link" >
                                Logo created by Doomero
                            </a>
                    </p>
                    <p 
                        className="background-link">
